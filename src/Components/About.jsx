              ...
              <div className="card content-box-card">
                <div className="card-body">
                  <div className="top-info">
                    <div className="text">
                      <h1 className="main-title">Hi, This Is <span>Cris Rayaan</span> 👋</h1>
                  ...
                  <div className="working-with-area">
                    <h2 className="main-common-title">Working With 50+ Brands ✨ Worldwide
                    </h2>
                  ...
                  <div className="awards-recognitions">
                    <h2 className="main-common-title">Awards and Recognitions
                    </h2>
                          ...
                          <a href="#" className="d-block w-100">
                            <div className="awards-item">
                              <div className="award-name">
                                ...
                                <div className="text">
                                  <h4 className="title">Dribbble Design Contest</h4>
                                  <p className="year">2022 - 2023</p>
                                </div>
                              </div>
                              <div className="winner-tag">
                          ...
                          <a href="#" className="d-block w-100">
                            <div className="awards-item">
                              <div className="award-name">
                                ...
                                <div className="text">
                                  <h4 className="title">Behance Design Contest</h4>
                                  <p className="year">2022 - 2023</p>
                                </div>
                              </div>
                              <div className="winner-tag">
                        ...
                        <div className="col-lg-6">
                          <div className="article-publications-item">
                            <div className="image">
                              ...
                              <a href="article.html" className="tags">Development</a>
                            </div>
                            <div className="text">
                              <a href="article.html" className="title">Want To Upgrade Your Brain? Stop Doing These 7
                                Things</a>
                              <ul className="list-unstyled">
                                <li>15 min read</li>
                                <li>Nov 6, 2023</li>
