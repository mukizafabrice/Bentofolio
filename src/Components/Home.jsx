                          ...
                          <ul className="work-experiance-slider list-unstyled">
                            ...
                            <li>
                              ...
                              <div className="info">
                                ...
                                <div className="text">
                                  <h4 className="title">Google Inc.</h4>
                                  <h6 className="subtitle">
                            ...
                            <li>
                              ...
                              <div className="info">
                                <div className="icon">
                                  <img
                                    src="assets/img/icons/meta.svg"
                                    alt="meta"
                                  />
                                </div>
                                <div className="text">
                                  <h4 className="title">Meta Inc.</h4>
                                  <h6 className="subtitle">Product Designer</h6>
                                </div>
                              </div>
                            </li>
                            <li>
