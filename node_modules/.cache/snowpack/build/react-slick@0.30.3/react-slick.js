...
import require$$1 from 'json2mq';
import require$$3$1 from 'enquire.js';
...
var require$$3 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(classnames);
...
var _react = _interopRequireDefault(require$$0);
var _classnames = _interopRequireDefault(require$$3);
...
var renderSlides = function renderSlides(spec) {
  ...
  _react["default"].Children.forEach(spec.children, function (elem, index) {
    ...
    if (spec.infinite && spec.fade === false) {
      ...
      if (preCloneNo <= (0, innerSliderUtils.getPreClones)(spec)) {
        key = -preCloneNo;
        if (key >= startIndex) {
          child = elem;
        }
...
var require$$4 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(resizeObserverPolyfill);
...
var _resizeObserverPolyfill = _interopRequireDefault(require$$4);
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _extends() { _extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
var _json2mq = _interopRequireDefault(require$$1);
var _defaultProps = _interopRequireDefault(defaultProps_1);
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : String(i); }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var enquire = (0, innerSliderUtils.canUseDOM)() && require$$3$1;
var Slider = exports["default"] = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      }, (0, innerSliderUtils.filterSettings)(settings)), newChildren);
    }
  }]);
  return Slider;
}(_react["default"].Component);
