import { createContext, useContext, useMemo, useRef, useCallback, createElement, useState, useEffect, startTransition, useLayoutEffect, Fragment, memo, Component, Children, isValidElement, forwardRef, useId, Suspense } from 'react';
...
function createRouter(init) {
  ...
  async function startNavigation(historyAction, location, opts) {
    ...
    if (opts && opts.pendingError) {
      ...
      let actionResult = await handleAction(request, location, opts.submission, matches, fogOfWar.active, {replace: opts.replace, flushSync});
...
var FetchersContext = createContext(/* @__PURE__ */ new Map());
...
function useHref(to, {relative} = {}) {
  ...
  let {basename, navigator: navigator2} = useContext(NavigationContext);
...
function useMatch(pattern) {
  ...
  return useMemo(() => matchPath(pattern, decodePath(pathname)), [pathname, pattern]);
}
...
function useOutlet(context) {
  ...
  if (outlet) {
    return /* @__PURE__ */ createElement(OutletContext.Provider, {value: context}, outlet);
  }
  return outlet;
}
function useParams() {
...
function useRoutesImpl(routes, locationArg, dataRouterState, future) {
  ...
  let {navigator: navigator2} = useContext(NavigationContext);
...
function DefaultErrorComponent() {
  ...
  let devInfo = null;
  {
    ...
    devInfo = /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement("p", null, "💿 Hey developer 👋"), /* @__PURE__ */ createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", /* @__PURE__ */ createElement("code", {style: codeStyles}, "ErrorBoundary"), " or", " ", /* @__PURE__ */ createElement("code", {style: codeStyles}, "errorElement"), " prop on your route."));
  }
  return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement("h2", null, "Unexpected Application Error!"), /* @__PURE__ */ createElement("h3", {style: {fontStyle: "italic"}}, message), stack ? /* @__PURE__ */ createElement("pre", {style: preStyles}, stack) : null, devInfo);
}
...
var RenderErrorBoundary = class extends Component {
  ...
  render() {
    return this.state.error !== void 0 ? /* @__PURE__ */ createElement(RouteContext.Provider, {value: this.props.routeContext}, /* @__PURE__ */ createElement(RouteErrorContext.Provider, {
...
function _renderMatches(matches, parentMatches = [], dataRouterState = null, future = null) {
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    let getChildren = () => {
      ...
      return /* @__PURE__ */ createElement(RenderedRoute, {
        match,
        routeContext: {
          outlet,
          matches: matches2,
    ...
    return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? /* @__PURE__ */ createElement(RenderErrorBoundary, {
...
function useBlocker(shouldBlock) {
  ...
  let [blockerKey, setBlockerKey] = useState("");
  let blockerFunction = useCallback((arg) => {
...
function useNavigateStable() {
  ...
  let navigate = useCallback(async (to, options = {}) => {
    warning(activeRef.current, navigateEffectWarning);
    if (!activeRef.current)
      return;
    if (typeof to === "number") {
...
function RouterProvider({
  ...
  let [state, setStateImpl] = useState(router.state);
  let [pendingState, setPendingState] = useState();
  let [vtContext, setVtContext] = useState({
    isTransitioning: false
  });
  let [renderDfd, setRenderDfd] = useState();
  let [transition, setTransition] = useState();
  let [interruption, setInterruption] = useState();
  let fetcherData = useRef(/* @__PURE__ */ new Map());
  let setState = useCallback((newState, {deletedFetchers, flushSync, viewTransitionOpts}) => {
  ...
  let dataRouterContext = useMemo(() => ({
    router,
    navigator: navigator2,
    static: false,
    basename
  }), [router, navigator2, basename]);
  return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement(DataRouterContext.Provider, {value: dataRouterContext}, /* @__PURE__ */ createElement(DataRouterStateContext.Provider, {value: state}, /* @__PURE__ */ createElement(FetchersContext.Provider, {value: fetcherData.current}, /* @__PURE__ */ createElement(ViewTransitionContext.Provider, {value: vtContext}, /* @__PURE__ */ createElement(Router, {
    basename,
    location: state.location,
    navigationType: state.historyAction,
    navigator: navigator2
  }, /* @__PURE__ */ createElement(MemoizedDataRoutes, {
...
function Await({
  ...
  return /* @__PURE__ */ createElement(AwaitErrorBoundary, {resolve, errorElement}, /* @__PURE__ */ createElement(ResolveAwait, null, children));
}
var AwaitErrorBoundary = class extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (status === 2) {
      return /* @__PURE__ */ createElement(AwaitContext.Provider, {value: promise, children: errorElement});
    }
    if (status === 1) {
      return /* @__PURE__ */ createElement(AwaitContext.Provider, {value: promise, children});
    }
    throw promise;
  }
};
function ResolveAwait({
  ...
  return /* @__PURE__ */ createElement(Fragment, null, toRender);
}
...
function StreamTransfer({
  ...
  let scriptTag = value ? /* @__PURE__ */ createElement("script", {
    nonce,
  ...
  if (done) {
    return /* @__PURE__ */ createElement(Fragment, null, scriptTag, /* @__PURE__ */ createElement("script", {
      nonce,
      dangerouslySetInnerHTML: {
    ...
    return /* @__PURE__ */ createElement(Fragment, null, scriptTag, /* @__PURE__ */ createElement(Suspense, null, /* @__PURE__ */ createElement(StreamTransfer, {
      context,
...
var RemixErrorBoundary = class extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    if (this.state.error) {
      return /* @__PURE__ */ createElement(RemixRootDefaultErrorBoundary, {
...
function RemixRootDefaultErrorBoundary({
  ...
  console.error(error);
  let heyDeveloper = /* @__PURE__ */ createElement("script", {
    dangerouslySetInnerHTML: {
      __html: `
        console.log(
  ...
  if (isRouteErrorResponse(error)) {
    return /* @__PURE__ */ createElement(BoundaryShell, {title: "Unhandled Thrown Response!"}, /* @__PURE__ */ createElement("h1", {style: {fontSize: "24px"}}, error.status, " ", error.statusText), heyDeveloper);
  }
  let errorInstance;
  ...
  return /* @__PURE__ */ createElement(BoundaryShell, {
    title: "Application Error!",
    isOutsideRemixApp
  }, /* @__PURE__ */ createElement("h1", {style: {fontSize: "24px"}}, "Application Error"), /* @__PURE__ */ createElement("pre", {
    style: {
      padding: "2rem",
...
function BoundaryShell({
  ...
  return /* @__PURE__ */ createElement("html", {lang: "en"}, /* @__PURE__ */ createElement("head", null, /* @__PURE__ */ createElement("meta", {charSet: "utf-8"}), /* @__PURE__ */ createElement("meta", {
    name: "viewport",
    content: "width=device-width,initial-scale=1,viewport-fit=cover"
  }), /* @__PURE__ */ createElement("title", null, title)), /* @__PURE__ */ createElement("body", null, /* @__PURE__ */ createElement("main", {style: {fontFamily: "system-ui, sans-serif", padding: "2rem"}}, children, renderScripts ? /* @__PURE__ */ createElement(Scripts, null) : null)));
}
function RemixRootDefaultHydrateFallback() {
  return /* @__PURE__ */ createElement(BoundaryShell, {title: "Loading...", renderScripts: true}, /* @__PURE__ */ createElement("script", {
    dangerouslySetInnerHTML: {
      __html: `
              console.log(
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  let ErrorBoundary = routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route.id === "root" ? () => /* @__PURE__ */ createElement(RemixRootDefaultErrorBoundary, {error: useRouteError()}) : void 0;
  if (route.id === "root" && routeModule.Layout) {
    return {
      ...Component4 ? {
        element: /* @__PURE__ */ createElement(routeModule.Layout, null, /* @__PURE__ */ createElement(Component4, null))
      } : {Component: Component4},
      ...ErrorBoundary ? {
        errorElement: /* @__PURE__ */ createElement(routeModule.Layout, null, /* @__PURE__ */ createElement(ErrorBoundary, null))
      } : {ErrorBoundary},
      ...HydrateFallback ? {
        hydrateFallbackElement: /* @__PURE__ */ createElement(routeModule.Layout, null, /* @__PURE__ */ createElement(HydrateFallback, null))
      } : {HydrateFallback}
    };
  }
...
function useDataRouterContext2() {
  let context = useContext(DataRouterContext);
  invariant2(context, "You must render this element inside a <DataRouterContext.Provider> element");
  return context;
}
function useDataRouterStateContext() {
  let context = useContext(DataRouterStateContext);
...
function usePrefetchBehavior(prefetch, theirElementProps) {
  let frameworkContext = useContext(FrameworkContext);
  let [maybePrefetch, setMaybePrefetch] = useState(false);
...
function Links() {
  ...
  let keyedLinks = useMemo(() => getKeyedLinksForMatches(matches, routeModules, manifest), [matches, routeModules, manifest]);
  return /* @__PURE__ */ createElement(Fragment, null, criticalCss ? /* @__PURE__ */ createElement("style", {dangerouslySetInnerHTML: {__html: criticalCss}}) : null, keyedLinks.map(({key, link}) => isPageLinkDescriptor(link) ? /* @__PURE__ */ createElement(PrefetchPageLinks, {key, ...link}) : /* @__PURE__ */ createElement("link", {key, ...link})));
}
function PrefetchPageLinks({
  ...
  let matches = useMemo(() => matchRoutes(router.routes, page, router.basename), [router.routes, page, router.basename]);
  if (!matches) {
    return null;
  }
...
function useKeyedPrefetchLinks(matches) {
  ...
  let [keyedPrefetchLinks, setKeyedPrefetchLinks] = useState([]);
  useEffect(() => {
...
function PrefetchPageLinksImpl({
  ...
  let newMatchesForData = useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, "data"), [page, nextMatches, matches, manifest, location]);
  let newMatchesForAssets = useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, "assets"), [page, nextMatches, matches, manifest, location]);
  let dataHrefs = useMemo(() => {
  ...
  let moduleHrefs = useMemo(() => getModuleLinkHrefs(newMatchesForAssets, manifest), [newMatchesForAssets, manifest]);
  let keyedPrefetchLinks = useKeyedPrefetchLinks(newMatchesForAssets);
  return /* @__PURE__ */ createElement(Fragment, null, dataHrefs.map((href) => /* @__PURE__ */ createElement("link", {key: href, rel: "prefetch", as: "fetch", href, ...linkProps})), moduleHrefs.map((href) => /* @__PURE__ */ createElement("link", {key: href, rel: "modulepreload", href, ...linkProps})), keyedPrefetchLinks.map(({key, link}) => /* @__PURE__ */ createElement("link", {key, ...link})));
}
function Meta() {
  ...
  return /* @__PURE__ */ createElement(Fragment, null, meta.flat().map((metaProps) => {
    if (!metaProps) {
      return null;
    }
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return /* @__PURE__ */ createElement(Comp, {key: JSON.stringify(rest), ...rest});
    }
    if ("title" in metaProps) {
      return /* @__PURE__ */ createElement("title", {key: "title"}, String(metaProps.title));
    }
    ...
    if ("charSet" in metaProps && metaProps.charSet != null) {
      return typeof metaProps.charSet === "string" ? /* @__PURE__ */ createElement("meta", {key: "charSet", charSet: metaProps.charSet}) : null;
    }
    ...
    return /* @__PURE__ */ createElement("meta", {key: JSON.stringify(metaProps), ...metaProps});
  }));
}
...
import(${JSON.stringify(manifest.entry.module)});`;
    return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement("script", {
      ...props,
      suppressHydrationWarning: true,
      dangerouslySetInnerHTML: createHtml(contextScript),
      type: void 0
    }), /* @__PURE__ */ createElement("script", {
      ...props,
      suppressHydrationWarning: true,
  ...
  return isHydrated ? null : /* @__PURE__ */ createElement(Fragment, null, !enableFogOfWar ? /* @__PURE__ */ createElement("link", {
    rel: "modulepreload",
    href: manifest.url,
    crossOrigin: props.crossOrigin
  }) : null, /* @__PURE__ */ createElement("link", {
    rel: "modulepreload",
    href: manifest.entry.module,
    crossOrigin: props.crossOrigin
  }), dedupe(preloads).map((path) => /* @__PURE__ */ createElement("link", {
    key: path,
    rel: "modulepreload",
    href: path,
    crossOrigin: props.crossOrigin
...
var Link = forwardRef(function LinkWithRef({
  onClick,
  discover = "render",
  prefetch = "none",
  relative,
  ...
  let link = /* @__PURE__ */ createElement("a", {
    ...rest,
    ...prefetchHandlers,
  ...
  return shouldPrefetch && !isAbsolute ? /* @__PURE__ */ createElement(Fragment, null, link, /* @__PURE__ */ createElement(PrefetchPageLinks, {page: href})) : link;
});
Link.displayName = "Link";
var NavLink = forwardRef(function NavLinkWithRef({
  ...
  let {navigator: navigator2, basename} = useContext(NavigationContext);
...
function ScrollRestoration({
  ...
  let remixContext = useContext(FrameworkContext);
  let {basename} = useContext(NavigationContext);
  let location = useLocation();
...
function useSearchParams(defaultInit) {
  ...
  let location = useLocation();
  let searchParams = useMemo(() => getSearchParamsForLocation(location.search, hasSetSearchParamsRef.current ? null : defaultSearchParamsRef.current), [location.search]);
  let navigate = useNavigate();
...
function useFetcher({
  ...
  let defaultKey = useId();
  let [fetcherKey, setFetcherKey] = useState(key || defaultKey);
  ...
  let load = useCallback(async (href, opts) => {
    invariant(routeId, "No routeId available for fetcher.load()");
    await router.fetch(fetcherKey, routeId, href, opts);
  }, [fetcherKey, routeId, router]);
  let submitImpl = useSubmit();
  let submit = useCallback(async (target, opts) => {
  ...
  let FetcherForm = useMemo(() => {
    let FetcherForm2 = forwardRef((props, ref) => {
      return /* @__PURE__ */ createElement(Form, {...props, navigate: false, fetcherKey, ref});
    });
...
function StaticRouterProvider({
  ...
  return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement(DataRouterContext.Provider, {value: dataRouterContext}, /* @__PURE__ */ createElement(DataRouterStateContext.Provider, {value: state}, /* @__PURE__ */ createElement(FetchersContext.Provider, {value: fetchersContext}, /* @__PURE__ */ createElement(ViewTransitionContext.Provider, {value: {isTransitioning: false}}, /* @__PURE__ */ createElement(Router, {
    basename: dataRouterContext.basename,
    location: state.location,
    navigationType: state.historyAction,
    navigator: dataRouterContext.navigator,
    static: dataRouterContext.static
  }, /* @__PURE__ */ createElement(DataRoutes2, {
    routes: router.routes,
    future: router.future,
    state
  })))))), hydrateScript ? /* @__PURE__ */ createElement("script", {
    suppressHydrationWarning: true,
    nonce,
...
function ServerRouter({
  ...
  }, /* @__PURE__ */ createElement(RemixErrorBoundary, {location: router.state.location}, /* @__PURE__ */ createElement(StaticRouterProvider, {
    router,
    context: context.staticHandlerContext,
    hydrate: false
  }))), context.serverHandoffStream ? /* @__PURE__ */ createElement(Suspense, null, /* @__PURE__ */ createElement(StreamTransfer, {
    context,
    identifier: 0,
...
function createRoutesStub(routes, context = {}) {
  return function RoutesTestStub({
    ...
    return /* @__PURE__ */ createElement(FrameworkContext.Provider, {value: remixContextRef.current}, /* @__PURE__ */ createElement(RouterProvider, {router: routerRef.current}));
  };
}
...
export { createHashRouter as $, Await as A, BrowserRouter as B, decodeViaTurboStream as C, DataRouterContext as D, ErrorResponseImpl as E, Form as F, deserializeErrors2 as G, HashRouter as H, IDLE_BLOCKER as I, getPatchRoutesOnNavigationFunction as J, getSingleFetchDataStrategy as K, Link as L, MemoryRouter as M, NavLink as N, Outlet as O, PrefetchPageLinks as P, invariant as Q, Route as R, Scripts as S, mapRouteProperties as T, shouldHydrateRouteLoader as U, ViewTransitionContext as V, useFogOFWarDiscovery as W, useScrollRestoration as X, createBrowserRouter as Y, createCookie as Z, createCookieSessionStorage as _, IDLE_FETCHER as a, createMemoryRouter as a0, createMemorySessionStorage as a1, createPath as a2, createRequestHandler as a3, createRoutesFromChildren as a4, createRoutesFromElements as a5, createRoutesStub as a6, createSearchParams as a7, createSession as a8, createSessionStorage as a9, useHref as aA, useInRouterContext as aB, useLinkClickHandler as aC, useLoaderData as aD, useLocation as aE, useMatch as aF, useMatches as aG, useNavigate as aH, useNavigation as aI, useNavigationType as aJ, useOutlet as aK, useOutletContext as aL, useParams as aM, useResolvedPath as aN, useRevalidator as aO, useRouteError as aP, useRouteLoaderData as aQ, useRoutes as aR, useSearchParams as aS, useSubmit as aT, useViewTransitionState as aU, createStaticHandler2 as aa, createStaticRouter as ab, data as ac, generatePath as ad, isCookie as ae, isRouteErrorResponse as af, isSession as ag, matchPath as ah, matchRoutes as ai, parsePath as aj, redirect as ak, redirectDocument as al, renderMatches as am, replace as an, resolvePath as ao, HistoryRouter as ap, setDevServerHooks as aq, usePrompt as ar, useActionData as as, useAsyncError as at, useAsyncValue as au, useBeforeUnload as av, useBlocker as aw, useFetcher as ax, useFetchers as ay, useFormAction as az, IDLE_NAVIGATION as b, Links as c, Meta as d, Navigate as e, Action as f, Router as g, RouterProvider as h, Routes as i, ScrollRestoration as j, ServerRouter as k, StaticRouter as l, StaticRouterProvider as m, DataRouterStateContext as n, FetchersContext as o, FrameworkContext as p, LocationContext as q, NavigationContext as r, RemixErrorBoundary as s, RouteContext as t, ServerMode as u, SingleFetchRedirectSymbol as v, createBrowserHistory as w, createClientRoutes as x, createClientRoutesWithHMRRevalidationOptOut as y, createRouter as z };
